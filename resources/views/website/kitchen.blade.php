			...
			<div class="w3ls_w3l_banner_nav_right_grid">
				...
				<div class="w3ls_w3l_banner_nav_right_grid_head_grids">
					<div class="col-md-4 w3ls_w3l_banner_nav_right_grid_head_grid">
						<img src="{{ url('website/images/22.jpg')}}" alt=" " class="img-responsive" />
						<h4>Bread & Bakery</h4>
						<ul>
					...
					<div class="col-md-4 w3ls_w3l_banner_nav_right_grid_head_grid">
						<img src="{{ url('website/images/23.jpg')}}" alt=" " class="img-responsive" />
						<h4>Beverages</h4>
						<ul>
							<li><a href="{{ url('drinks')}}">Juices</a></li>
							<li><a href="{{ url('drinks')}}">Soft Drinks</a></li>
							<li><a href="{{ url('drinks')}}">Energy Drinks</a></li>
						</ul>
					</div>
					<div class="col-md-4 w3ls_w3l_banner_nav_right_grid_head_grid">
