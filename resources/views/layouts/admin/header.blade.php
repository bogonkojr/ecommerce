...
<head>
    ...
    <title>EcoMass Dashboard</title>



    <link rel="shortcut icon" href="{{ url('admin/compiled/svg/favicon.svg')}}" type="image/x-icon">
    ...
    <link rel="stylesheet" href="{{ url('admin/extensions/datatables.net-bs5/css/dataTables.bootstrap5.min.css')}}">

    <link rel="stylesheet" href="{{ url('admin/compiled/css/app.css')}}">
    <link rel="stylesheet" href="{{ url('admin/compiled/css/app-dark.css')}}">
    <link rel="stylesheet" href="{{ url('admin/compiled/css/iconly.css')}}">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">

</head>

<body>
    <script src="{{ url('admin/static/js/initTheme.js')}}"></script>
    <div id="app">
        <div id="sidebar">
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="{{ url('portal/')}}"><img src="{{ url('admin/compiled/svg/logo.svg')}}" alt="Logo" srcset=""></a>
                        </div>
...
<div class="sidebar-menu">
    ...
    <ul class="menu">
        ...
        <li
        class="sidebar-item @if(Request::is('portal/')) active @endif active">
    ...
    <ul class="submenu ">
     ...
     <li class="submenu-item "><a href="{{ url('admin-unit-product-types/'.$product_type->id) }}" class="submenu-link">{{ $product_type->name }}</a></li>
     @endforeach
...
<li class="sidebar-item  ">
    <a href="{{ url('portal/users')}}" class='sidebar-link'>
        <i class="bi bi-person-badge-fill"></i>
        <span>Users</span>
    </a>
</li>
<li class="sidebar-item  ">
    <a href="{{ url('portal/units')}}" class='sidebar-link'>
        <i class="bi bi-person-badge-fill"></i>
        <span>Units</span>
    </a>
</li>
<li class="sidebar-item  ">
    <a href="{{ url('admin-unit-product-types/'.$product_type->id) }}" class='sidebar-link'>
        <i class="bi bi-person-badge-fill"></i>
...
<li class="sidebar-item  has-sub">
    ...
    <ul class="submenu ">
        ...
        <li class="submenu-item  "><a href="{{ route('portal.index', $unit->id) }}" class="submenu-link">{{ $unit->name }}</a></li>
        @endforeach
